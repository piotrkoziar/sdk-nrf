...
#define HT_DT_HAS_RESERVED_DPPIC_CHANNEL		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(dppic130), sink_channels, _HT_DT_CHECK_DPPIC_CHANNEL) false), \
	(false))
...
#define HT_DT_HAS_RESERVED_DPPIC_G2_CHANNEL		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(dppic132), source_channels, _HT_DT_CHECK_DPPIC_G2_CHANNEL) false), \
	(false))
...
#define HT_DT_HAS_RESERVED_IPCT_L_LINK		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(cpurad_ipct), sink_channel_links, _HT_DT_CHECK_IPCT_L_LINK) false), \
	(false))
...
#define TS_DT_HAS_RESERVED_IPCT_G1_LINK		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(ipct130), source_channel_links, _HT_DT_CHECK_IPCT_G1_LINK) false), \
	(false))
