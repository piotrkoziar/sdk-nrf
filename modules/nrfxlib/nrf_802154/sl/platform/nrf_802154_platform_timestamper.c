...
#define TS_DT_HAS_RESERVED_DPPIC_G1_CHANNEL		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(dppic130), source_channels, _TS_DT_CHECK_DPPIC_G1_CHANNEL) false), \
	(false))
...
#define TS_DT_HAS_RESERVED_DPPIC_G2_CHANNEL		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(dppic132), sink_channels, _TS_DT_CHECK_DPPIC_G2_CHANNEL) false), \
	(false))
 ...
 * };
 * where first 0 corresponds to IPCT_L_TS_CHANNEL.
 */
...
#define TS_DT_HAS_RESERVED_IPCT_L_LINK		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(cpurad_ipct), source_channel_links, _TS_DT_CHECK_IPCT_L_LINK) false), \
	(false))
 ...
 * };
 * where first 0 corresponds to IPCT_G1_TS_CHANNEL.
 */
...
#define TS_DT_HAS_RESERVED_IPCT_G1_LINK		\
	...
	(DT_FOREACH_PROP_ELEM(DT_NODELABEL(ipct130), sink_channel_links, _TS_DT_CHECK_IPCT_G1_LINK) false), \
	(false))
